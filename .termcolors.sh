...
end="${TC}0m"     # Reset all coloring and style
...
# echo "${Bold}${Undr}${Green}You can reset this whole style in one${end} command"
# echo -n "${Bold}${Blue}${OnWhite}bold blue text on white background${end}"; sleep 3; echo "${RESET_LINE}${Red}${OnYellow}becomes red text on yellow background${end}"